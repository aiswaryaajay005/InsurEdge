...
$type = 'Vehicle'; // Set the policy type
$query = "SELECT * FROM policies WHERE type = '$type'"; // Query to fetch vehicle policies
...
<head>
    ...
    <title>Auto Insurance Policies</title>
...
<body>
    ...
    <main>
        ...
        <div class="login-prompt">
            <p>To choose a policy, please <a href="../User/Userlogin.php">Login</a> or <a href="../API/Register.php">Register</a>.</p>
        </div>
    </main>
    <footer>
